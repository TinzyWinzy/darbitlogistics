...
export default function Sidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      {/* Overlay for mobile */}
      {isMobile && isOpen && <div className="sidebar-overlay d-lg-none position-fixed top-0 start-0 w-100 h-100 bg-dark bg-opacity-50" onClick={onClose} style={{ zIndex: 1040 }} />}
      {/* Only render sidebar nav on mobile if open, always render on desktop */}
      {(!isMobile || isOpen) && (
        <nav
          ref={sidebarRef}
