...
export default function ParentBookingForm({
  ...
  return (
    <>
      <div className="modal fade show" style={{ display: 'block', zIndex: 1051, position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', overflowY: 'auto' }} tabIndex="-1" role="dialog" aria-modal="true">
